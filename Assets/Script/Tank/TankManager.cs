...
public class TankManager: MonoBehaviour
{
    ...
    [Inject]
    private void Construct(ITankMovement tankMovement, IInputManager inputManager, ITurretControl turretControl, IWeaponController weaponController, Rigidbody rigi)
    {
